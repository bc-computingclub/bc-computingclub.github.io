...
let titleCont = document.querySelector(".co-cont") as HTMLElement;
...
getStartedButton.addEventListener("animationend", (event) => {
    if(event.animationName == "fade-out-btn") {
        ...
        prevBtn = document.querySelector(".previous") as HTMLButtonElement;
...
function updateFeatures() {
    if(!titleCont.classList.contains("altpos")) {titleCont.classList.add("altpos")};
    let temp = document.createElement("div");
