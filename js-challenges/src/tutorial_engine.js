...
class Project {
    constructor(ref, ta) {
        this.ref = ref;
        this.area = ref.parentElement?.nextElementSibling;
        this.ta = ta;
    }
    // line = 0;
    // col = 0;
...
async function createCodeFile(text, ext, title) {
...
async function executeActions(file, actions) {
    if (!file) {
